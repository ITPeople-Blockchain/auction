...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface) pb.Response {
	...
	/*
		for _, val := range aucTables {
			// The concept of Table does not exist so we delete all objects prefixed with the
			// collection name

			err = itpUtils.DeleteAllObjects(stub, val)
			if err != nil {
				fmt.Println("Init(): InitLedger of %s  Failed ", val)
				return shim.Error("Init(): DeleteAllObjects of %s  Failed ")
			}
			err = itpUtils.InitObject(stub, val, []string{""})
			if err != nil {
				fmt.Println("Init(): InitLedger of %s  Failed ", val)
				return shim.Error("Init(): InitLedger of %s  Failed ")
			}
		}
	*/
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	fmt.Println("==========================================================")
	fmt.Println("BEGIN Function ====> %s", function)
	if function[0:1] == "i" {
		fmt.Println("==========================================================")
